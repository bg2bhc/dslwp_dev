...
# Title: demod_dslwp_gmsk_b1
# Generated: Wed Jul 24 07:34:32 2019
##################################################
...
class demod_dslwp_gmsk_b1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.low_pass_filter_3_0_0 = filter.fir_filter_ccf(10, firdes.low_pass(
        	1, if_rate, 1.6e3, 0.3e3, firdes.WIN_HAMMING, 6.76))
        ...
        self.dslwp_program_tracking_cc_0 = dslwp.program_tracking_cc(True, '/home/lilac/dslwp_dev/program_tracking_dslwp-b_20190722.txt', lon, lat, alt, 436400000, if_rate, False, True)
        self.dslwp_oqpsk_coherent_demod_cc_0 = dslwp.oqpsk_coherent_demod_cc(sps*2, ([0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000005, 0.000035, 0.000189, 0.000787, 0.002569, 0.006746, 0.014618, 0.026868, 0.043018, 0.061431, 0.079856, 0.096160, 0.108824, 0.117144, 0.121157, 0.121157, 0.117144, 0.108824, 0.096160, 0.079856, 0.061431, 0.043018, 0.026868, 0.014618, 0.006746, 0.002569, 0.000787, 0.000189, 0.000035, 0.000005, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000]), 4, 1, 2.0*math.pi*pll_loop_bw/samp_rate, 0.707, 3.14, -3.14, 0, 0.05, 0.707, 1.5, 100)
        ...
        self.dslwp_frame_spliter_c_0 = dslwp.frame_spliter_c('payload_start', 7152)
        self.dslwp_ccsds_turbo_decode_0 = dslwp.ccsds_turbo_decode(223, 1, 4, 2, 0.707, 0)
        ...
        self.msg_connect((self.dslwp_tm_header_parser_0, 'out 1'), (self.blocks_message_debug_0, 'print_pdu'))
    ...
    def set_if_rate(self, if_rate):
        ...
        self.low_pass_filter_3_0_0.set_taps(firdes.low_pass(1, self.if_rate, 1.6e3, 0.3e3, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=demod_dslwp_gmsk_b1, options=None):
