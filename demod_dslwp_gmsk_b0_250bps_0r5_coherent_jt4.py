...
# Title: demod_dslwp_gmsk_b0_250bps_0r5_coherent_jt4
# Generated: Sun Aug  5 07:56:07 2018
##################################################
...
class demod_dslwp_gmsk_b0_250bps_0r5_coherent_jt4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "demod_dslwp_gmsk_b0_250bps_0r5_coherent_jt4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("demod_dslwp_gmsk_b0_250bps_0r5_coherent_jt4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demod_dslwp_gmsk_b0_250bps_0r5_coherent_jt4")
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_win, 5, 0, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self.fft_correlator_hier_0, 6, 0, 1, 1)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.dslwp_program_tracking_cc_0 = dslwp.program_tracking_cc(True, '/home/lilac/dslwp_dev/program_tracking_dslwp-b_20180803.txt', lon, lat, alt, 435400000, if_rate, False, True)
        self.dslwp_oqpsk_coherent_demod_cc_0 = dslwp.oqpsk_coherent_demod_cc(sps*2, ([0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000005, 0.000035, 0.000189, 0.000787, 0.002569, 0.006746, 0.014618, 0.026868, 0.043018, 0.061431, 0.079856, 0.096160, 0.108824, 0.117144, 0.121157, 0.121157, 0.117144, 0.108824, 0.096160, 0.079856, 0.061431, 0.043018, 0.026868, 0.014618, 0.006746, 0.002569, 0.000787, 0.000189, 0.000035, 0.000005, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000]), 4, 1, 2.0*math.pi*pll_loop_bw/samp_rate, 0.707, 3.14, -3.14, 0, 0.05, 0.707, 1.5)
        ...
        self.blocks_udp_source_0 = blocks.udp_source(gr.sizeof_gr_complex*1, '127.0.0.1', 7161, 1472, False)
        self.blocks_socket_pdu_0 = blocks.socket_pdu("TCP_CLIENT", '127.0.0.1', '60063', 10000, False)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_message_debug_0_0_0 = blocks.message_debug()
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.band_pass_filter_0 = filter.fir_filter_ccf(5, firdes.band_pass(
        	10.0**(af_gain/20.0), if_rate, 300, 3000, 500, firdes.WIN_HAMMING, 6.76))
        ...
        self.connect((self.dslwp_program_tracking_cc_0, 0), (self.band_pass_filter_0, 0))
    ...
    def set_if_rate(self, if_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(10.0**(self.af_gain/20.0), self.if_rate, 300, 3000, 500, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=demod_dslwp_gmsk_b0_250bps_0r5_coherent_jt4, options=None):
