...
# Title: demod_dslwp_gmsk_b0
# Generated: Fri Jun  7 17:19:58 2019
##################################################
...
class demod_dslwp_gmsk_b0(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "demod_dslwp_gmsk_b0")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("demod_dslwp_gmsk_b0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demod_dslwp_gmsk_b0")
        ...
        ##################################################
        self.sps = sps = 8
        self.ebn0_threshold = ebn0_threshold = -4
        ...
        self.low_pass_filter_3_0_0 = filter.fir_filter_ccf(10, firdes.low_pass(
        	1, 48e3, 1.6e3, 0.3e3, firdes.WIN_HAMMING, 6.76))
        ...
        self.dslwp_program_tracking_cc_0 = dslwp.program_tracking_cc(True, '/home/lilac/DSLWP_Tracker/program_tracking_dslwp-b_20190607.txt', 126.627, 45.73, 156, 435400000, if_rate, False, True)
...
def main(top_block_cls=demod_dslwp_gmsk_b0, options=None):
